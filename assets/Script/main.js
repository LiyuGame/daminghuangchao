...
cc.Class({
    ...
    onLoad () {
        ...
        if(cc.sys.platform === cc.sys.WECHAT_GAME){
            ...
            wx.createFeedbackButton({
                type: 'image',
                image: 'https://damingchao.oss-cn-shenzhen.aliyuncs.com/fk.png',
                style: {
                    left: 20,
                    top: 150,
                    width: 35,
    ...
    gameDouble(num){
        ...
        // this._timeNum = num;
        // this.jiasuBtn.runAction(cc.sequence(cc.repeat(cc.sequence(cc.callFunc(() => {
        //     this.jiasuBtn.getChildByName("numbg").getChildByName("number").getComponent(cc.Label).string = "0:" + (this._timeNum--);
        // }), cc.delayTime(1)), num), cc.callFunc(() => {
        //     this.jiasuBtn.color = cc.Color.WHITE;
        //     this.jiasuBtn.getComponent(cc.Button).interactable = true;
        //     this.jiasuBtn.getChildByName("numbg").active = false;
        //     for (let i = 0; i < GameConfig.Row; i++) {
        //         for (let j = 0; j < GameConfig.Col; j++) {
        //             this.deskArr[i][j].isSelect = false;
        //         }
        //     }
        // })));
        let timer=null;
